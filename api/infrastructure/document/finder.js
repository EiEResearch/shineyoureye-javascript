...
import MarkdownWithFrontmatter from 'api/infrastructure/document/markdown-with-frontmatter';
import NoFilesFoundError from 'api/infrastructure/document/exceptions';
...
export default class Finder {
  ...
  get filenames() {
    const filenames = sync(this.pattern);
