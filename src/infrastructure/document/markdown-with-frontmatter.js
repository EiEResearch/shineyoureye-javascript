...
import MarkdownParser from '@/infrastructure/document/markdown-parser';
import FrontmatterParser from '@/infrastructure/document/frontmatter-parser';
...
export default class MarkdownWithFrontmatter {
  ...
  get filecontents() {
    const filecontents = File.readFileSync(this.filename, 'utf8');
    return filecontents;
  }
