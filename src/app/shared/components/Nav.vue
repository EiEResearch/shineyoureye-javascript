  ...
  <b-navbar toggleable="lg" variant="default">
    ...
    <b-collapse id="nav-collapse" is-nav>
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item href="#">Democracy Resources</b-nav-item>

        <b-nav-item-dropdown text="Elections">
          <b-dropdown-item href="#">Elections</b-dropdown-item>
          <b-dropdown-item href="#">Voting Information</b-dropdown-item>
        </b-nav-item-dropdown>

        <b-nav-item-dropdown text="Government Officials">
          <b-dropdown-item href="#">Government Officials</b-dropdown-item>
        ...
        <b-nav-item-dropdown text="Places">
          <b-dropdown-item href="#">Places</b-dropdown-item>
