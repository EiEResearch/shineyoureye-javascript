            ...
            <div class="row my-3">
              ...
              <div class='row my-3'>
                <h4 class='align-items-center'>
                  ...
                  If you have any urgent inquiries or require immediate assistance, please do not hesitate to <br />contact our customer support team at <strong>syeinfo@eienigeria.org</strong>. We are here to help.
                </h4>
              </div>
            </div>
          </div>
